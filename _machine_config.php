...
GlobalConfig::$CONNECTION_SETTING->DBName = "w2o";
...
/** the root url of the application with trailing slash, for example http://localhost/w2o/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'w2o/';
