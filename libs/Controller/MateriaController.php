...
class MateriaController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($page != '')
			{
				...
				$materias = $this->Phreezer->Query('MateriaReporter',$criteria)->GetDataPage($page, $pagesize);
			...
			{
				// return all results
				$materias = $this->Phreezer->Query('MateriaReporter',$criteria);
				$output->rows = $materias->ToObjectArray(true, $this->SimpleObjectParams());
	...
	public function Create()
	{
		try
		{
			...
			// $materia->Id = $this->SafeGetVal($json, 'id');

			$materia->Nome = $this->SafeGetVal($json, 'nome');
	...
	public function Update()
	{
		try
		{
			...
			// $materia->Id = $this->SafeGetVal($json, 'id', $materia->Id);

			$materia->Nome = $this->SafeGetVal($json, 'nome', $materia->Nome);
