...
require_once("DAO/GradehorariaCriteriaDAO.php");

/**
 * The GradehorariaCriteria class extends GradehorariaDAOCriteria and is used
 ...
 * @version 1.0
 */
class GradehorariaCriteria extends GradehorariaCriteriaDAO
{
