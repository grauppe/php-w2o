...
require_once("DAO/ProfessorCriteriaDAO.php");

/**
 * The ProfessorCriteria class extends ProfessorDAOCriteria and is used
 ...
 * @version 1.0
 */
class ProfessorCriteria extends ProfessorCriteriaDAO
{
