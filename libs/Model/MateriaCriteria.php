...
require_once("DAO/MateriaCriteriaDAO.php");

/**
 * The MateriaCriteria class extends MateriaDAOCriteria and is used
 ...
 * @version 1.0
 */
class MateriaCriteria extends MateriaCriteriaDAO
{
