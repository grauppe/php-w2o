/**
 * backbone model definitions for W2O
 */
...
/**
 * Feria Backbone Model
 */
model.FeriaModel = Backbone.Model.extend({
	urlRoot: 'api/feria',
	idAttribute: 'id',
	id: '',
	professorid: '',
...
/**
 * Feria Backbone Collection
 */
model.FeriaCollection = model.AbstractCollection.extend({
	url: 'api/ferias',
	model: model.FeriaModel
});

/**
 * Gradehoraria Backbone Model
 */
model.GradehorariaModel = Backbone.Model.extend({
	urlRoot: 'api/gradehoraria',
	idAttribute: 'id',
	id: '',
	horario: '',
	grademensal: '',
...
/**
 * Gradehoraria Backbone Collection
 */
model.GradehorariaCollection = model.AbstractCollection.extend({
	url: 'api/gradeshorarias',
	model: model.GradehorariaModel
});
